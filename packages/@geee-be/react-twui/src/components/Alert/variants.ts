...
export const alertVariants = cva({
  variants: {
    ...
    color: {
      default: 'border-default-border bg-default-soft text-paper-content default-default',
      primary: 'border-primary-border bg-primary-soft text-paper-content default-primary',
      secondary: 'border-secondary-border bg-secondary-soft text-paper-content default-secondary',
      info: 'border-info-border bg-info-soft text-paper-content default-info',
      warning: 'border-warning-border bg-warning-soft text-paper-content default-warning',
      success: 'border-success-border bg-success-soft text-paper-content default-success',
      error: 'border-error-border bg-error-soft text-paper-content default-error',
    },
  },
  defaultVariants: {
    variant: 'inline',
